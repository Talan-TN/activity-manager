...
if (modelType == 'runtime') {
	if (historyModelId) {
    	modelUrl = ACTIVITI.CONFIG.contextRoot + '/rest/process-instances/history/' + historyModelId + '/model-json';
	} else {
    	modelUrl = ACTIVITI.CONFIG.contextRoot + '/rest/process-instances/' + modelId + '/model-json';
	}
    ...
    modelUrl = ACTIVITI.CONFIG.contextRoot + '/rest/process-definitions/' + processDefinitionId + '/model-json';
}
