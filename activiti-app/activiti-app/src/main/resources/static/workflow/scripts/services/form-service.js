    ...
    function ($http, $q) {
        ...
        this.getTaskForm = function(taskId) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/task-forms/' + taskId
                }
            );
        };
        ...
        this.saveTaskForm = function(taskId, data) {
            ...
            var promise = httpAsPromise(
                {
                    method: 'POST',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/task-forms/' + taskId + '/save-form',
                    data: data
                }
            );
        ...
        this.getStartForm = function(processDefinitionId) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/process-definitions/' + processDefinitionId + "/start-form"
                }
            );
        };
        ...
        this.completeStartForm = function(data) {
            ...
            var promise = httpAsPromise(
                {
                    method: 'POST',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/process-instances/',
                    data: data
                }
            );
