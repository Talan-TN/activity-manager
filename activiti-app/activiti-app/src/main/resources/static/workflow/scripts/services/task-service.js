    ...
    function ($http, $q, $rootScope, RelatedContentService) {
        ...
        this.getProcessInstanceTasks = function(processInstanceId, isCompleted) {
            ...
            return httpAsPromise(
                {
                    method: 'POST',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/query/tasks',
                    data: data
                }
            );
        ...
        this.involveUserInTask = function(userId, taskId) {
            ...
            var promise = httpAsPromise(
                {
                    method: 'PUT',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId + '/action/involve',
                    data: involveData
                }
            );
        ...
        this.removeInvolvedUserInTask = function(user, taskId) {
            ...
            var promise = httpAsPromise(
                {
                    method: 'PUT',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId + '/action/remove-involved',
        ...
        this.completeTask = function(taskId) {
            ...
            $http( {
                method: 'PUT',
                url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId + '/action/complete'
            }).
            success(function (response, status, headers, config) {
        ...
        this.claimTask = function(taskId) {
            var promise = httpAsPromise(
                {
                    method: 'PUT',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId + '/action/claim'
                }
            );
        ...
        this.assignTask = function(taskId, userId) {
            ...
            var promise = httpAsPromise(
                {
                    method: 'PUT',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId + '/action/assign',
                    data: assignData
                }
            );
        ...
        this.updateTask = function(taskId, data) {
            return httpAsPromise(
                {
                    method: 'PUT',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks/' + taskId,
                    data: data
                }
            );
        };
        ...
        this.createTask = function(taskData) {
            ...
            $http({
                method: 'POST',
                url: ACTIVITI.CONFIG.contextRoot + '/rest/tasks',
                data: taskData
            }).
            success(function (response, status, headers, config) {
        ...
        this.getProcessInstanceVariables = function(taskId) {
          ...
          return httpAsPromise(
            {
              method: 'GET',
              url: ACTIVITI.CONFIG.contextRoot + '/rest/task-forms/' + taskId + '/variables',
              data: data
            }
          );
        }
