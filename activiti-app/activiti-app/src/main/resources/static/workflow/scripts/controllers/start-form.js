...
angular.module('activitiApp')
    ...
    $scope.getProcessInstance = function(processInstanceId) {
        $http({method: 'GET', url: ACTIVITI.CONFIG.contextRoot + '/rest/process-instances/' + processInstanceId}).
    ...
    $scope.loadStartForm = function(processInstanceId) {
        $http({method: 'GET', url: ACTIVITI.CONFIG.contextRoot + '/rest/process-instances/' + processInstanceId + '/start-form'}).
            success(function(response, status, headers, config) {
