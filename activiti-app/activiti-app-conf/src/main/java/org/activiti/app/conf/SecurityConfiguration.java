	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http
	            ...
	            .authorizeRequests()
	                ...
	                .antMatchers("/rest/integration/login").permitAll()
	                .antMatchers("/rest/temporary/example-options").permitAll()
	                .antMatchers("/rest/idm/email-actions/*").permitAll()
	                .antMatchers("/rest/idm/signups").permitAll()
	                .antMatchers("/rest/idm/passwords").permitAll()
	        ...
	        loginConfig.loginProcessingUrl("/rest/authentication")
