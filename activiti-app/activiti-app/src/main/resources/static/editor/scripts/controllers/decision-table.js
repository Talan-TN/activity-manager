        ...
        function ($rootScope, $scope, $translate, $http, $location, $routeParams, $modal, $timeout, $popover, DecisionTableService, uiGridConstants) {
            ...
            $scope.loadDecisionTable = function() {
                ...
                if ($routeParams.modelHistoryId) {
                    ...
                    decisionTableUrl = ACTIVITI.CONFIG.contextRoot + '/rest/decision-table-models/history/' + $routeParams.modelHistoryId;
                } else {
                    url = ACTIVITI.CONFIG.contextRoot + '/rest/models/' + $routeParams.modelId;
                    decisionTableUrl = ACTIVITI.CONFIG.contextRoot + '/rest/decision-table-models/' + $routeParams.modelId;
                }
