...
.controller('ImportDecisionTableModelCtrl', ['$rootScope', '$scope', '$http', 'Upload', '$location', function ($rootScope, $scope, $http, Upload, $location ) {
  ...
  $scope.onFileSelect = function($files, isIE) {
      ...
      for (var i = 0; i < $files.length; i++) {
          ...
          var url;
          if (isIE) {
              url = ACTIVITI.CONFIG.contextRoot + '/rest/decision-table-models/import-decision-table-text';
          } else {
              url = ACTIVITI.CONFIG.contextRoot + '/rest/decision-table-models/import-decision-table';
          }
