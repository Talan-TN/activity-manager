        ...
        */
        ...
        this.getProfile = function () {
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/profile'
                }
            )
        };
        ...
        this.changePassword = function(oldPassword, newPassword) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/profile-password',
        ...
        */
        ...
        this.getGroups = function() {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/groups',
                    params: params
                }
            )
        };
        ...
        this.getGroup = function (groupId, includeAllUsers) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/groups/' + groupId,
                    params: params
                }
            )
        };
        ...
        this.getUsersForGroup = function(groupId, filter, page, pageSize) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/groups/' + groupId + '/users',
                    params: params
                }
            )
        ...
        this.activateGroup = function(groupId) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/groups/' + groupId + '/action/activate'
                }
            )
        };
        ...
        this.deleteGroupMember = function(groupId, userId) {
            return httpAsPromise(
                {
                    method: 'DELETE',
                    url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/groups/' + groupId + '/members/' + userId
                }
            )
        };
