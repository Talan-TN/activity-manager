...
public class ProcessInstanceClientResource extends AbstractClientResource {
    ...
    @RequestMapping(value = "/rest/activiti/process-instances/{processDefinitionKey}/{processInstanceId}/functionalEntity", method = RequestMethod.GET)
    public List<Triple> getFunctionalEntity(@PathVariable String processDefinitionKey, @PathVariable String processInstanceId) throws BadRequestException {
        return this.functionalMappingService.getProcessInstanceFunctionalEntity(processDefinitionKey,processInstanceId);
    }
