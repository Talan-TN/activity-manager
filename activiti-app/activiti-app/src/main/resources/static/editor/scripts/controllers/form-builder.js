        ...
        function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal, $routeParams, $popover, FormBuilderService) {
            ...
            if ($routeParams.modelId) {
                ...
                if ($routeParams.modelHistoryId) {
                    url = ACTIVITI.CONFIG.contextRoot + '/rest/form-models/' + $routeParams.modelId + '/history/' + $routeParams.modelHistoryId;
                } else {
                    url = ACTIVITI.CONFIG.contextRoot + '/rest/form-models/' + $routeParams.modelId;
                }
