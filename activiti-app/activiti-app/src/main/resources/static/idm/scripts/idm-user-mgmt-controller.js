...
activitiApp.controller('IdmUserMgmtController', ['$rootScope', '$scope', '$translate', '$http', '$timeout','$location', '$modal',
    function ($rootScope, $scope, $translate, $http, $timeout, $location, $modal) {
        ...
        $scope.loadUsers = function() {
            ...
            $http({method: 'GET', url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/users', params: params}).
        ...
        $scope.deleteUsers = function() {
            ...
            $scope.getSelectedUsers().forEach(function(selectedUser) {
                $http({method: 'DELETE', url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/users/' + selectedUser.id}).
                    success(function (data, status, headers, config) {
...
activitiApp.controller('IdmCreateUserPopupController', ['$rootScope', '$scope', '$http',
    function ($rootScope, $scope, $http) {
        ...
        $scope.createNewUser = function () {
            ...
            $http({method: 'POST', url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/users', data: data}).
                success(function (data, status, headers, config) {
        ...
        $scope.editUserDetails = function() {
            ...
            $http({method: 'PUT', url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/users/' + $scope.model.user.id, data: data}).
                success(function (data, status, headers, config) {
...
activitiApp.controller('IdmUserBulkUpdatePopupController', ['$rootScope', '$scope', '$http',
  function ($rootScope, $scope, $http) {
     ...
     $scope.updateUsers = function () {
       ...
       $http({method: 'PUT', url: ACTIVITI.CONFIG.contextRoot + '/rest/admin/users', data: data})
           .success(function(data, status, headers, config) {
                $scope.$hide();
                $scope.model.loading = false;
